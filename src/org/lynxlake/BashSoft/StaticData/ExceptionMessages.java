...
public class ExceptionMessages {
    ...
    public static final String NON_EXISTING_COURSE = "Course doesn`t exist";
    public static final String NON_EXISTING_STUDENT = "Student doesn`t exist";
    public static final String INVALID_PATH = "File doesn`t exist";
